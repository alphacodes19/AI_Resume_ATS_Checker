...
APP_VERSION = '1.0.0'
APP_DESCRIPTION = 'analyZe resumes against job desciption using nlp + ml'
...
#supported MIME types and thier short names
...
SENTENCE_TRANSFORMER_MODEL = os.getenv("SENTENCE_TRNASFORMER_MODEL", "all-MiniLM-L6-v2")
